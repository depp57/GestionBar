begin
    compte_creer('Hautière', 'Alain');
    compte_creer('Rouhling', 'Amicale');
    compte_creer('Philippe', 'Anne-L');
    compte_creer('Wagner', 'Bernard');
    compte_creer('Feicht', 'Fabrice');
    compte_creer('1', 'Inconnue');
    compte_creer('Sp', 'Inter');
    compte_creer('Hamm', 'Kévin');
    compte_creer('Majon', 'Ltt');
    compte_creer('Vintier', 'Maxime');
    compte_creer('Schuster', 'Patrick');
    compte_creer('Europapark', 'Sortie');
    compte_creer('Schmitt', 'Yannick');
end;
...
INSERT INTO SYSTEM.STOCK_INFO (TOTALACHAT, TOTALVENTE) VALUES (0.0, 0.0);
